    ...
    <?php } ?>
        ...
        <header id="top-nav">
            ...
            <nav>
                ...
                <div id="menuz">
                    <div id="main-menu"><?php wp_nav_menu( array( 'theme_location' => 'header-menu' ) ); ?></div>
                    <div id="secondary-menu"><?php wp_nav_menu( array( 'theme_location' => 'header-secondary-menu' ) ); ?></div>
                </div>
                <div id="usercrap">
                <li>
                    <?php if (!is_user_logged_in()) {
                        ...
                        echo '
                            ...
                            <a id="Logout" href="' . wp_logout_url(home_url()) . '">Logout</a>
                        ';
                    } ?>
                </li>
                </div>
                <div id="side-menu-link">&#8801</div>
            </nav>
            </div>
